...
class MAEAdapter(MaskedAutoencoderViT):
    def __init__(self, pretrain_size=224, conv_inplane=64, n_points=4, deform_num_heads=6,
        ...
        self.pos_drop = nn.Dropout(p=kwargs.get('drop_rate', 0.))
        ...
        self.interactions = nn.Sequential(*[
            InteractionBlock(dim=embed_dim, num_heads=deform_num_heads, n_points=n_points,
                             init_values=init_values, drop_path=kwargs.get('drop_path_rate', 0.),
                             ...
                             with_cp=with_cp, num_prefix_tokens=1 + self.num_register_tokens)
    ...
    def forward(self, x):
        ...
        if self.num_register_tokens > 0:
            ...
            cls = torch.cat([cls, register_tokens], dim=1)
