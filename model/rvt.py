...
class RvT(nn.Module):
    def __init__(self, *, image_size, patch_size, dim, depth, heads, mlp_dim, channels = 3, dim_head = 64, dropout = 0., use_rotary = True, use_ds_conv = True, use_glu = True, is_decoder = False):
        super().__init__()
    ...
    def forward(self, x, h, w):
        b, _, _, p = *x.shape, self.patch_size
        n = x.shape[1]
