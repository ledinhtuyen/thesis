...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 mlp_ratio=4., norm_layer=nn.LayerNorm, norm_pix_loss=False, num_register_tokens=0, use_conv_stem=False):
        super().__init__()
...
def mae_vit_base_patch16_dec512d8b_with_register_convstem(**kwargs):
    model = MaskedAutoencoderViT(
        patch_size=16, embed_dim=768, depth=12, num_heads=12,
        decoder_embed_dim=512, decoder_depth=8, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), num_register_tokens=4, 
        use_conv_stem=True,**kwargs)
    return model
...
def mae_vit_large_patch16_dec512d8b_with_register(**kwargs):
    model = MaskedAutoencoderViT(
        patch_size=16, embed_dim=1024, depth=24, num_heads=16,
        decoder_embed_dim=512, decoder_depth=8, decoder_num_heads=16,
        mlp_ratio=4, norm_layer=partial(nn.LayerNorm, eps=1e-6), num_register_tokens=4, **kwargs)
...
mae_vit_base_patch16_with_register_convstem = mae_vit_base_patch16_dec512d8b_with_register_convstem
mae_vit_large_patch16_with_register = mae_vit_large_patch16_dec512d8b_with_register
